import "./fedNotificationTable.scss";
  ...
  useEffect(() => {
    ...
    onAuthStateChanged(auth, (user) => {
      ...
      if (docSnap.exists()) {
        ...
        const q = query(collection(db, "requests"), where("SendTo", "==", "Federation")); 
...
export default FedNotificationTable;